...
def thesaurus(*args) -> dict:
    dict_out = {}
    for names in sorted(args):
        first_letter = names[0]
        dict_out.setdefault(first_letter,[])
        dict_out[first_letter].append(names)
    return dict_out

print(thesaurus("Иван", "Мария", "Петр", "Илья", "Павел", "Женя", "Марина", "Жорик"))
